...
<div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
  ...
  <p class="mt-3 max-w-xl text-lg leading-relaxed text-crust">
    Confira as quantidades antes de mandar. Nada é cobrado aqui — o acerto é na conversa com a unidade.
  </p>
  ...
  <div class="mt-9 grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-start">
    ...
    <div>
      <!-- Estado vazio -->
      <div data-cart-empty class="flex flex-col items-center gap-3 rounded-bandeja border border-dashed border-base-300 bg-papel px-6 py-16 text-center">
        ...
        <p class="max-w-sm text-sm leading-relaxed text-crust">
          Escolha os itens no catálogo. Eles ficam guardados neste navegador até você fechar o pedido.
        </p>
        <a href="index.php#catalogo" class="btn btn-primary mt-1 font-bold">
          Ver o catálogo
        </a>
      </div>
      ...
      <ul data-cart-items
          class="oculto divide-y divide-base-300 overflow-hidden rounded-bandeja border border-base-300 bg-papel shadow-bandeja"></ul>
    ...
    <aside class="rounded-bandeja border border-base-300 bg-papel p-6 shadow-bandeja lg:sticky lg:top-24">
      ...
      <div class="mt-4 rounded-2xl bg-base-200 p-4">
        ...
        <p class="mt-0.5 text-sm font-bold" data-unit-label>Escolher unidade</p>
        <p class="mt-1.5 text-xs leading-relaxed text-crust">
          Troque no seletor de unidade, no topo da página. É para ela que o pedido vai.
        </p>
      </div>
      ...
      <p class="mt-1.5 text-xs leading-relaxed text-crust">
        Valor de referência com base na tabela do site. A unidade confirma preço, prazo e frete.
      </p>
      ...
      <p class="mt-3 text-xs leading-relaxed text-crust">
        O botão abre o WhatsApp com o pedido já escrito. Você ainda pode editar antes de enviar.
      </p>
    </aside>
  </div>
</div>
